...
//Calculator Advance Features & Algo//
...
function runCalculator() {
        ...
        operandButtons.forEach((button) => {
            button.addEventListener('click', () =>{
                ...
                //append to num2 if multiple numbers are pressed and display out
                    ...
                    console.log("saved first value is: ", num2)
    ...
    function getOperatorSelection() {
        ...
        operatorButtons.forEach((button) => {
            button.addEventListener('click', () => {
                ...
                console.log("store temp operator in arraay for string calcs: ", tempOperatorArray);
                ...
                if ((tempNum1Array != "") && (tempNum2Array != "")) {
                    ...
                    let tempOperatorArray = tempOperatorArray[tempOperatorArray.length - 2].toString();
    ...
    //DOM for "+/-" button
    const signButton = document.querySelector(".clear");
    ...
    const decimalButton = document.querySelector(".decimal");
        decimalButton.addEventListener('click', () => {
            ...
            //append "decimal" to numarray 1 and display out
            if (operator == "") {
                const calcDisplay = document.querySelector("#display");
